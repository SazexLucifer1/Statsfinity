...
- Es gibt **11 Spec-Dateien** (`scryfall.service`, `public-deck.service`, `color-filter-match`, `color-combo-names`, `app-recovery`, `bracket`, `combo-finder`, `goldfish-sim`, `sim-card-profile`, `ui/radar-chart/radar-geometry`, `i18n/i18n-keys`). Die Tests sind **kein Sicherheitsnetz** — grüne Tests sagen fast nichts. Am dichtesten getestet ist der Simulator; dort ist ein roter Test ein echtes Signal.
