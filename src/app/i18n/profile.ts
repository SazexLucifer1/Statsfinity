...
export const profile = {
  de: {
    ...
    'profile.devFullViewOn': 'Vollansicht',
    'profile.devFullViewOff': 'Normale Ansicht',
    'profile.devFullViewHint':
      'Developer-Vollansicht: alle Statistiken und Decks dieses Profils, genau so, wie der Spieler sie selbst sieht – nur zum Ansehen.',
    ...
    'profile.matchHistoryGames': 'Spiele',
    'profile.matchHistoryWins': 'Siege',
    'profile.matchHistoryRate': 'Siegquote',
    'profile.matchHistoryWin': 'Sieg',
    'profile.matchHistoryLoss': 'Niederlage',
    'profile.matchHistoryDraw': 'Unentschieden',
    'profile.matchHistorySelf': 'Du',
    'profile.matchHistoryOpenDeck': 'Deck „{{name}}“ ansehen',
    ...
    'profile.linkCommanderHint':
      'Wähle einen noch nicht zugeordneten Commander und das passende Deck, falls die automatische Erkennung nichts gefunden hat. Mit "Geliehen" markierte Commander hängen an einem fremden Deck – wählst du hier ein eigenes Deck, werden diese Spiele übernommen.',
    ...
    'profile.unlinkHint':
      'Falls ein Deck fälschlich verlinkt wurde: hier die Verknüpfung aller seiner Spiele wieder aufheben – sie wandern zurück zu "Commander ohne Deck". Mit "Geliehen" markierte Einträge sind geliehene Decks; solange du selbst kein Deck mit diesem Commander hast, wird die Leihe danach wieder erkannt.',
    ...
    'profile.uploadBackground': 'Hintergrund hochladen',
    ...
    'profile.dataExportButton': 'Daten herunterladen',
    ...
    'profile.poolSectionTitle': 'Archidekt-Deckvorrat',
    'profile.poolSectionHint':
      'Importierte fremde Commander-Decks als Referenz für die Bracket-Auswertung. Nur für dich sichtbar.',
    'profile.poolOpen': 'Deckvorrat ansehen',
    'profile.poolTitle': 'Archidekt-Deckvorrat',
    'profile.poolClose': '← Profil',
    ...
    'profile.poolCardsFailed': 'Die Kartenliste konnte nicht geladen werden.',
    'profile.poolCardCount': '{{count}} Karten',
  ...
  en: {
    ...
    'profile.developerBadge': 'Developer',
    'profile.devFullViewOn': 'Full view',
    'profile.devFullViewOff': 'Normal view',
    'profile.devFullViewHint':
      'Developer full view: every statistic and deck of this profile, exactly as the player sees them – read-only.',
    'profile.npcBadge': 'NPC',
    ...
    'profile.matchHistoryGames': 'Games',
    'profile.matchHistoryWins': 'Wins',
    'profile.matchHistoryRate': 'Win rate',
    'profile.matchHistoryWin': 'Win',
    'profile.matchHistoryLoss': 'Loss',
    'profile.matchHistoryDraw': 'Draw',
    'profile.matchHistorySelf': 'You',
    'profile.matchHistoryOpenDeck': 'View deck “{{name}}”',
    ...
    'profile.linkCommanderHint':
      'Choose a not-yet-assigned commander and the matching deck, in case automatic detection didn\'t find anything. Commanders marked "Borrowed" are linked to someone else\'s deck – picking one of your own decks here moves those games over.',
    ...
    'profile.unlinkHint':
      'If a deck was linked incorrectly: undo the link for all its games here – they move back to "Commander without deck". Entries marked "Borrowed" are borrowed decks; as long as you don\'t own a deck with that commander yourself, the loan will be detected again afterwards.',
    ...
    'profile.dataExportButton': 'Download data',
    ...
    'profile.poolSectionTitle': 'Archidekt deck pool',
    'profile.poolSectionHint':
      'Imported external commander decks as a reference for the bracket evaluation. Only visible to you.',
    'profile.poolOpen': 'View deck pool',
    'profile.poolTitle': 'Archidekt deck pool',
    'profile.poolClose': '← Profile',
    ...
    'profile.poolCardsFailed': 'The card list could not be loaded.',
    'profile.poolCardCount': '{{count}} cards',
